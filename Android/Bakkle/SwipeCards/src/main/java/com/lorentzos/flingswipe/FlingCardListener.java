...
public class FlingCardListener implements View.OnTouchListener, View.OnClickListener
{
    ...
    {
        this(frame, itemAtPosition, 15f, Direction.ALL, flingListener);
    }
    ...
    public void onSelected(final int direction, float exitOther, long duration)
    {
