...
import com.bakkle.bakkle.RuntimePermissionActivity;
...
//        Log.d(TAG, "original bitmap width " + bitmap.getWidth() + " height " + bitmap.getHeight());
    ...
    private void savePicture() {
        ...
        getFragmentManager().beginTransaction()
                .add(R.id.content_frame, InputDetailsFragment.newInstance(),
                     Constants.INPUT_DETAILS).commit();
    }

    private void requestForPermission() {
        RuntimePermissionActivity.startActivity(EditSavePhotoFragment.this,
                                                REQUEST_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE);
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (REQUEST_STORAGE == requestCode && data != null) {
            ...
            if (isGranted && view != null) {
                ...
                ((AddItemActivity) getActivity()).addPhotoUri(photoUri);
            }
        } else {
