...
//        }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        mPreviewView.getHolder().addCallback(TakePictureFragment.this);
...
//        Log.d(TAG, "Rotate Picture by: " + rotation);
        getFragmentManager().beginTransaction()
                .replace(R.id.content_frame, EditSavePhotoFragment.newInstance(data, rotation,
                                                                               mImageParameters.createCopy()),
