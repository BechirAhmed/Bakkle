...
public class RegistrationIntentService extends IntentService
{
    ...
    {
        //API.getInstance(getApplicationContext()).registerPush(token);
...
//            Log.v("test", token);
            ...
            if (Prefs.getInstance(this).isLoggedIn() && !Prefs.getInstance(this).isRegistered()) {
                API.getInstance(this)
                        .registerPush(GoogleCloudMessaging.getInstance(this)
