...
public class PlaybackVideoFragment extends Fragment
        implements CameraUriInterface, View.OnClickListener, EMEventBus,
                   ...
                   MediaPlayer.OnCompletionListener
{
    ...
    private final Runnable mCountdownRunnable = new Runnable()
    {
        ...
        public void run()
        {
            if (mPlaybackContinueCountdownLabel != null && mPlaybackContinueCountdownLabel.getVisibility() == View.VISIBLE) {
                ...
                mPlaybackContinueCountdownLabel.setText(
    ...
    public void onViewCreated(View view, Bundle savedInstanceState)
    {
        ...
        mPlaybackContinueCountdownLabel = (TextView) view.findViewById(
                R.id.playbackContinueCountdownLabel);
        ...
        int primaryColor = CameraUtil.darkenColor(
                getArguments().getInt(CameraIntentKey.PRIMARY_COLOR));
        primaryColor = Color.argb((int) (255 * 0.75f), Color.red(primaryColor),
                Color.green(primaryColor), Color.blue(primaryColor));
        mControlsFrame.setBackgroundColor(primaryColor);

        mRetry.setVisibility(getArguments().getBoolean(CameraIntentKey.ALLOW_RETRY,
    ...
    public void post(Object event)
    {
        if (event instanceof EMMediaProgressEvent) {
            ...
            try {
                ...
                mDuration.setText(String.format("-%s",
                        CameraUtil.getDurationString(duration - currentPosition)));
            } catch (Throwable t) {
    ...
    public void onClick(View v)
    {
        if (v.getId() == R.id.playbackFrame) {
            ...
            final float targetAlpha = mControlsFrame.getAlpha() == 1f ? 0f : mControlsFrame.getAlpha() == 0f ? 1f : mControlsFrame
                    .getAlpha() > 0.5f ? 0f : 1f;
    ...
    public boolean onError(MediaPlayer mp, int what, int extra)
    {
        ...
        new MaterialDialog.Builder(getActivity()).title("Playback Error")
                .content(errorMsg)
