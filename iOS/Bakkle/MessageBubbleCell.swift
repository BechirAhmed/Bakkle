...
class MessageBubbleCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        bubbleImageView.addConstraint(NSLayoutConstraint(item: messageLabel, attribute: .CenterX, relatedBy: .Equal, toItem: bubbleImageView, attribute: .CenterX, multiplier: 1, constant: 0))
...
func bubbleImageMake() -> (incoming: UIImage, incomingHighlighed: UIImage, outgoing: UIImage, outgoingHighlighed: UIImage) {
    ...
    let incoming = coloredImage(maskIncoming, red: 50/255.0, green: 50/255.0, blue: 50/255.0, alpha: 1).resizableImageWithCapInsets(capInsetsIncoming)
    let incomingHighlighted = coloredImage(maskIncoming, red: 50/255.0, green: 50/255.0, blue: 50/255.0, alpha: 1).resizableImageWithCapInsets(capInsetsIncoming)
    let outgoing = coloredImage(maskOutgoing, red: 51/255.0, green: 205/255.0, blue: 95/255.0, alpha: 1).resizableImageWithCapInsets(capInsetsOutgoing)
    let outgoingHighlighted = coloredImage(maskOutgoing, red: 51/255.0, green: 205/255.0, blue: 95/255.0, alpha: 1).resizableImageWithCapInsets(capInsetsOutgoing)
