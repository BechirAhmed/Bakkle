...
class BuyersTrunkCell : UITableViewCell {
    ...
    func loadCell(imgURLs: [String], title: String, price: String, delivery: String, tags: [String]) {
...
//            }
            ...
            cell.loadCell(imgURLs, title: title, price: price, delivery: delivery, tags: tags)
        } else {
            // No items in trunk
